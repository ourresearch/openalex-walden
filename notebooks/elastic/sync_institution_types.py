...
if spark.catalog.tableExists("openalex.common.institution_types_api"):
    spark.sql("""
        CREATE OR REPLACE TABLE openalex.common.institution_types_api_hash AS
        ...
        FROM openalex.common.institution_types_api
    """)
else:
    spark.sql("""
        CREATE TABLE IF NOT EXISTS openalex.common.institution_types_api_hash (
...
# MAGIC %sql
# MAGIC -- Rebuild institution_types_api table
...
# MAGIC     FROM openalex.common.institution_types_api
# MAGIC )
# MAGIC MERGE INTO openalex.common.institution_types_api AS target
# MAGIC USING (
# MAGIC     SELECT n.id,
# MAGIC         CASE
...
# MAGIC     LEFT JOIN openalex.common.institution_types_api_hash p ON n.id = p.id
# MAGIC ) AS source
