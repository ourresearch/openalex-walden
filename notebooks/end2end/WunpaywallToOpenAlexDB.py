...
# MAGIC
# MAGIC     # safety
# MAGIC     if record_count > LARGE_RECORD_COUNT and not wunpaywall_guard_override:
# MAGIC         error_msg = f"Too many records found to export ({record_count:,}). Set wunpaywall_guard_override=true to proceed anyway, or run manually"
# MAGIC         print(error_msg)
# MAGIC         raise Exception(error_msg)
# MAGIC     elif record_count > LARGE_RECORD_COUNT and wunpaywall_guard_override:
