...
get_openalex_type_from_repo_udf = udf(get_openalex_type_from_repo, StringType())
...
parsed_df = clean_df \
    ...
    .withColumn("authors", 
        ...
        """)) \
    .withColumn("type", get_openalex_type_from_repo_udf(regexp_extract(col("cleaned_xml"), r"<dc:type.*?>(.*?)</dc:type>", 1))) \
