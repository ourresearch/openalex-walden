...
# MAGIC %pip install /Volumes/openalex/default/libraries/openalex_dlt_utils-0.3.28-py3-none-any.whl
...
def pdf_enriched():
    ...
    # Under #880, DOI-less PDFs have no key because PDF never sets normalized_title; the 09-15 refresh dropped 2,278,933 rows for this reason.
    # Keep every PDF row as before #880; PDF rows attach downstream by URL (see the union's commented-out title filter).
