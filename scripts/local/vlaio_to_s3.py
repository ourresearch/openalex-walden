#!/usr/bin/env python3
"""
VLAIO/IWT (Flanders Innovation & Entrepreneurship, Belgium) awards.
...
PROVENANCE = "vlaio_fris"
FWO_FUNDER_NAME = "flanders innovation & entrepreneurship"   # the FRIS Funding-Party org name (lower-cased)
COUNTRY = "BE"
S3_BUCKET = "openalex-ingest"
S3_KEY = "awards/vlaio/vlaio_projects.parquet"
PAGE_SIZE = 100
...
def parse_project(project: ET.Element) -> Optional[dict]:
    ...
    funder_award_id = grant_id or (f"vlaio-{uuid}" if uuid else None)
...
def main() -> None:
    ...
    out = args.output_dir / "vlaio_projects.parquet"
