#!/usr/bin/env python3
"""
Vlaamse Regering (Flemish Government, Belgium) awards.
...
S3_KEY = "awards/vlaamse_regering/vlaamse_regering_projects.parquet"
PAGE_SIZE = 100
...
def parse_project(project: ET.Element) -> Optional[dict]:
    ...
    funder_award_id = grant_id or (f"vlaamse-{uuid}" if uuid else None)
...
def main() -> None:
    ...
    out = args.output_dir / "vlaamse_regering_projects.parquet"
